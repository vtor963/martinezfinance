...
// GridScan (React Bits) adaptado p/ Martinez Finance: sem webcam/face-api,
// grade + feixe roxo com bloom. Usado só no web (boas-vindas).
const vert = `
varying vec2 vUv;
void main(){
  vUv = uv;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  if (uLineStyle > 0.5) {
    ...
    if (uLineStyle < 1.5) {
      ...
      float dotMaskX2 = 1.0 - smoothstep(dotWidth2, dotWidth2 + fwidth(gridUV.x * dotRepeat2), cx2);
      lineX2 *= dotMaskY2;
      lineY2 *= dotMaskX2;
    }
  }
...
const GridScanBg = ({
  ...
  useEffect(() => {
    ...
    scanPhaseTaper, scanDuration, scanDelay, lightMode,
  ]);
